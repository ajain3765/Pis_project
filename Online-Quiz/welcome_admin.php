        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="welcome_admin.php?q=0">Home<span class="sr-only">(current)</span></a></li>
                    <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="welcome_admin.php?q=1">Remove Student</a></li>
                    <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="welcome_admin.php?q=2">Remove Teacher</a></li>
				 <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="welcome_admin.php?q=3">Add Teacher</a></li>
                </ul>
            ...
            <div class="col-md-12">
				...
				<?php 
                    if(@$_GET['q']==2) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$name.'</center></td><td><center>'.$email.'</center></td><td><center><a title="Delete admin" href="update.php?femail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center></td></tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
                    }
                ?>
                  ...
                  <?php
                    if(@$_GET['q']==3  ) 
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Enter Teacher Details</b></span><br /><br />
                        <div class="col-md-3"></div><div class="col-md-6">   
                        <form class="form-horizontal title1" name="form" action="update.php?q=add_teacher"  method="POST">
                            <fieldset>
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            $good = $row['good'];
                            $eid = $row['eid'];
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$title.'</center></td><td><center>'.$total.'</center></td><td><center>'.$good*$total.'</center></td>
